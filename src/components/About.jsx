    ...
    return (
        <div className="w-[100vw] h-screen bg-[#075985] overflow-clip font-roboto">
            <div className="w-[100%] h-[50%] translate-y-[-11%]  rounded-bl-[50vw] bg-[#d9d9d9] flex flex-col justify-between">
                <div className="w-[100%] h-[45%]  flex items-center justify-end pr-32 pt-24">
            ...
            <div className="w-[100%] h-[50%] flex flex-col justify-between *:*:text-center">
                ...
                <div className="w-[100%] h-[45%] flex items-center justify-evenly *:gap-3">

                    <div className="w-[10%] *:w-[100%] flex flex-col items-center justify-between ">
